                                        ...
                                        <div class="card-body p-4">
                                            <form id="billingForm" method="POST" class="row g-3 needs-validation"
                                                ...
                                                <div class="col-md-9 mb-2">
                                                    <h2 class="mb-1 text-center text-uppercase fw-bold">Guest Other Billings
                                                    </h2>
                                                </div>
                                                <hr class="mb-4">
        ...
        $(document).ready(function() {
            ...
            function printBill(formData, currentTime) {
                ...
                const printContent = `
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="left">
                                <p class="fw-bold">Guest Billing : <span style="font-weight: normal;">Other</span></p>
                ...
                printWindow.onafterprint = function() {
                    printWindow.close();
                    window.location.href = "{{ route('other-billing.index') }}";
                };
            }

            function updateBillingTable() {
                $.ajax({
                    url: '{{ route('other-billing.latest') }}',
                    type: 'GET',
                    success: function(response) {
